<template>
	<div class="review-video">
		<div class="review-video__info" :class="{ 'review-video__info--full': full, 'review-video__info--active': active, 'review-video__info--round': round }">
			<div class="review-video__preview" :class="{'review-video__preview--active': active, 'review-video__preview--round': round}" @click="() => {if(full) videoPlay()}">
				<Avatar :src="review.src" :size="full ? 180 : 130" :alt="review.name" v-show="!active" class="review-video__avatar"/>
				<video ref="videoItem" :src="src" muted controls class="review-video__video" v-show="active"></video>
				<Transition name="fade">
					<Icon :name="IconPlayMedia" v-if="full && !active" class="review-video__play" />
				</Transition>
			</div>
