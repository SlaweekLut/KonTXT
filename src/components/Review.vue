	...
	<div class="review" :class="{ 'review--full': full }">
		...
		<div class="review__info">
			...
			<div class="review__name">
				<p class="text-main review__title">{{ review.name }} <Icon :name="IconVerify" :size="24" v-if="review.isVerified && full"/> </p>
				...
				<p class="text-main review__text review__text--mobile" v-if="full">{{ text }}</p>
			</div>
